...
namespace CMS.Shared
{
    ...
    public class SchoolSetupNotifications
    {
        public static string SetupStarted = "Setup Started...";
        ...
        public static string SetupInProgress = "Setting up an Account... ";
        public static string SetupCompleted = "Setup Completed";
